      ...
      <div className="relative flex h-screen w-full flex-col overflow-hidden max-w-[430px] mx-auto bg-background-light dark:bg-background-dark font-display text-slate-900 dark:text-slate-100 antialiased italic-none">
        ...
        <div className="relative flex-1">
          ...
          <div className="relative w-full h-full px-6 flex flex-col justify-center">
            ...
            <div 
              ...
              style={{ backgroundImage: 'url("https://lh3.googleusercontent.com/aida-public/AB6AXuBt0cLCTcSxuV1VGXMXcdWVOPPC-1th_otgIO4cWQvxe8klWw9LpklV3CgllZyZytQpr60rjvVFirtZWwskbZmmkTdgCCOCsHa_kMEkKrn5LxBj0f6Vv_swIORpJCgSpa_z3cbeyJETwgZltKSw5RAD6p6R3j9M5znloX68W1GBHIWK4l0DzRvo2CN15L3IPQwVLROMsyfku7W7zPMo1_vFa7pRXPnx7vM1VBVQfI9dePEFtRg_ZOalmNf3qcy9emHaAZJvRIcBR0Yj")' }}
            >
        ...
        <div className="px-6 pb-12 pt-4 z-10">
          <div className="flex flex-col gap-4">
            {/* Email Input Field (Integrated) */}
            <input 
              type="email"
              placeholder="Email Address"
              value={email}
              onChange={(e) => setEmail(e.target.value)}
              className="h-14 w-full bg-white/5 border border-white/10 rounded-full px-6 text-white text-base focus:outline-none focus:ring-2 focus:ring-primary focus:border-transparent transition-all"
            />
            ...
            {/* Google */}
            <button className="flex h-14 w-full cursor-pointer items-center justify-center gap-3 overflow-hidden rounded-full bg-white/5 backdrop-blur-xl border border-white/10 text-slate-100 text-base font-semibold leading-normal transition-all hover:bg-white/10 active:scale-95">
          ...
          <div className="mt-8 text-center pb-8">
            <p className="text-xs text-slate-500 leading-relaxed px-4">
              ...
              <a className="text-primary hover:underline" href="#">Terms of Service</a> and <a class="text-primary hover:underline" href="#">Privacy Policy</a>
            </p>
            <div className="mt-6 flex items-center justify-center gap-2">
              <span className="text-sm text-slate-400">Already have an account?</span>
              <button className="text-sm font-bold text-primary hover:opacity-80">Log In</button>
            </div>
          </div>
        </div>
