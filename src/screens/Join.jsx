        ...
        <div className="px-6 pb-10 pt-4 z-10 space-y-4">
          ...
          <div className="flex flex-col gap-3">
            ...
            <div className="grid grid-cols-2 gap-3">
              {/* Google */}
              <button className="flex h-14 cursor-pointer items-center justify-center gap-2 rounded-2xl bg-white/5 border border-white/10 text-white text-sm font-semibold transition-all hover:bg-white/10 active:scale-95">
